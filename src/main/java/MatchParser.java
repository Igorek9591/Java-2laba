...
public class MatchParser
{
    ...
    public Double getVariable(String variableName)
    {
        if (!variables.containsKey(variableName)) {
            throw new ParserException( "Error: Try get unexists variable '"+variableName+"'" );
        }
    ...
    public double Parse(String s) throws Exception
    {
        ...
        if (!result.rest.isEmpty()) {
            throw new ParserException("Error: can't full parse");
        }
        return result.acc;
    }
    ...
    private Result Bracket(String s) throws Exception
    {
        ...
        if (zeroChar == '(') {
            ...
            if (!r.rest.isEmpty() && r.rest.charAt(0) == ')') {
                ...
                throw new ParserException("Error: not close bracket");
            }
            return r;
        }
    ...
    private Result Num(String s) throws Exception
    {
        ...
        while (i < s.length() && (Character.isDigit(s.charAt(i)) || s.charAt(i) == '.')) {
            ...
            if (s.charAt(i) == '.' && ++dot_cnt > 1) {
                throw new ParserException("not valid number '" + s.substring(0, i + 1) + "'");
            }
            i++;
        }
        if( i == 0 ){ // что-либо похожее на число мы не нашли
            throw new ParserException( "can't get valid number in '" + s + "'" );
        }
    ...
    private Result processFunction(String func, Result r)
    {
        if (func.equals("sin")) {
            ...
            throw new ParserException("function '" + func + "' is not defined");
        }
    }
}
